...
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    let url = 'https://telegra.ph/file/0d4ee0e0274b3c0908ce4.jpg'
...
`, text.trim(), flaa, [
    ...
    ], m, { 'document':{'url':'https:/instagram.com/gaara_xploite'},
...
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        ...
                        mediaType: 2,
                        description: `⚘ ᴄʀᴇᴀᴛᴇ ᴹᴿ᭄ Ꭰᥲʀκɴᴇꜱ ×፝֟͜×`,
                        title: `💌 My Ultah: ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`,
                        body: `⚘ by ᴹᴿ᭄ Ꭰᥲʀκɴᴇꜱ ×፝֟͜×`,          previewType: 0,
