...
contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, 
title: 'VIDEO',
body: 'ᴹᴿ᭄ Ꭰᥲʀκɴᴇꜱ ×፝֟͜×',         
previewType: 0, thumbnail: await (await fetch('https://telegra.ph/file/0d4ee0e0274b3c0908ce4.jpg')).buffer(),
sourceUrl: `https://youtu.be/pwLZpdfO8AU`}}})
let res = await fetch("https://api.dhamzxploit.my.id/api/ytplaymp4?text="+text)
let json = await res.json()
conn.sendFile(m.chat, json.result.url, 'error.mp4', `_ᴹᴿ᭄ Ꭰᥲʀκɴᴇꜱ ×፝֟͜×_`, m)}
}catch(e){
